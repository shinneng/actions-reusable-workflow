...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    && echo "deb [arch=$(dpkg --print-architecture) signed-by=/etc/apt/keyrings/githubcli-archive-keyring.gpg] https://cli.github.com/packages stable main" | tee /etc/apt/sources.list.d/github-cli.sources \
    && apt-get update \
